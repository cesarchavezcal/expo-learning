...
| Skill | Trigger / Command | Source | Description |
|---|---|---|---|
| [`init-project`](file:///Users/cesaradalbertochavezcalderon/Personal/expo-learning/.agents/skills/init-project/SKILL.md) | `/init-project` | `cesarchavezcal/agent-boilerplate` | Bootstrap a new repository created from agent-boilerplate. Use when starting a new project, when CONTEXT.md contains uninitialized placeholders ([Your Project Name]), or when asked to initialize/setup the project. |
| [`find-skills`](file:///Users/cesaradalbertochavezcalderon/Personal/expo-learning/.agents/skills/find-skills/SKILL.md) | `/find-skills` | `vercel-labs/skills` | Discover and install agent skills dynamically across 4 pillars (design, coding, testing, infra). |
| [`ask-matt`](file:///Users/cesaradalbertochavezcalderon/Personal/expo-learning/.agents/skills/ask-matt/SKILL.md) | `/ask-matt` | `mattpocock/skills` | Ask which skill or flow fits your situation. A router over the skills in this repo. |
